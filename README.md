...
* increases capacity (charge),
* adds/expands protection by damage groups,
* requires rarer resources to craft.

The shield works like a gas bottle: the charge is stored in the item itself.
